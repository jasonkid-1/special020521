...
$pdf->SetXY(13,48.5);
    ...
    $pdf->SetFont('Arial','B',14);
    $pdf->Cell(0,8,'ACCOUNTING\'S COPY',0,1,'C');//END ACCOUNTING'S COPY==============================
...
$pdf ->Cell(0,5,'REGISTRAR\'S COPY',0,1,'C');
...
$pdf ->SetFont('Arial','B',12);
$pdf->SetXY(4,125);
$pdf ->Cell(0,5,'STUDENT\'S COPY',0,1,'C');
...
$pdf ->Cell(63,4,'Baptized:   When                        Where',0,1,'L');
...
// //cell(width,height,text,border,end line,[align])
    ...
    $pdf->Cell(.1,5.5,"",'R',0);
    $pdf->Cell(65.9,5.5,"Provincial Address",'T',0);
    $pdf->Cell(.1,5.5,"",'R',1);
